...
@section('title', $tchallenge->chall_name)
@section('active-chall', 'active')
@section('content')
    <div class="col-sm-12" style="text-align: center">
        <h1 class="col-sm-12"><b>{{$tchallenge->chall_name}}<b></h1>
        <div class="col-sm-12">
            <button type="submit" class="btn btn-primary" onclick="alert('{{$tchallenge->hint}}')">Show hint <i class="fa-solid fa-lightbulb"></i></button>
        </div>
        <form action="{{route('tchallenges.edit', $tchallenge)}}" method="POST" class="col-sm-12">
