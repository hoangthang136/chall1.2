...
@section('content')
    <div style="margin-left: 40px">
        <form action="{{route('tassignments.store')}}" method="POST" enctype="multipart/form-data">
            <h3 style="margin-top: 0px; margin-bottom: 20px;color: #673AB7;"><b>ADD ASSIGNMENT</b></h3>
            <div class="form-group row">
                <label for="inputFullname3" class="col-sm-1 col-form-label">Title</label>
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="title" id="inputFullname3" placeholder="Title" value="{{old('title')}}">
                </div>
            </div>
            @error('title')
