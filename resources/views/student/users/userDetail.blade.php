                ...
                <div class="send-mess" >
                    ...
                    <div class="card">
                        <div class="content table-responsive table-full-width">
                            <form action="{{route('messStore')}}" method="POST" style="margin: 0px 20px">
                                @csrf
                            ...
                            <tbody>
                                ...
                                @else
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('messEdit', $mess_send)}}"><div class="edit" style="background-color: #03A9F4;">edit</div></a>
                                            <form action="{{route('messDestroy', $mess_send)}}" method="post" style="display:inline-block">
                                                @method("DELETE")
                                                @csrf
